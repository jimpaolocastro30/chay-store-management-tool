...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(ellipse_at_top_left,#0f766e_0%,#0b3d3a_40%,#082f2c_100%)]">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col justify-center gap-10 px-4 py-12 lg:flex-row lg:items-center lg:gap-16">
        <div className="animate-fade-up max-w-xl text-teal-50">
          ...
          <p className="mt-2 text-lg text-teal-100/90">
        ...
        <form
          onSubmit={onSubmit}
          className="animate-fade-up w-full max-w-md rounded-3xl border border-white/15 bg-white/95 p-6 shadow-2xl shadow-teal-950/40 backdrop-blur sm:p-8"
